...
const (
	...
	BCRequestDeathNotification   = uint32(uintptr(iocWrite)<<iocDirShift | uintptr('c')<<iocTypeShift | uintptr(14)<<iocNRShift | uintptr(binderHandleCookieSize)<<iocSizeShift)
	BCClearDeathNotification     = uint32(uintptr(iocWrite)<<iocDirShift | uintptr('c')<<iocTypeShift | uintptr(15)<<iocNRShift | uintptr(binderHandleCookieSize)<<iocSizeShift)
	BCDeadBinderDone             = uint32(uintptr(iocWrite)<<iocDirShift | uintptr('c')<<iocTypeShift | uintptr(16)<<iocNRShift | uintptr(unsafe.Sizeof(uint64(0)))<<iocSizeShift)
	...
	BRDeadBinder                 = uint32(uintptr(iocRead)<<iocDirShift | uintptr('r')<<iocTypeShift | uintptr(15)<<iocNRShift | uintptr(unsafe.Sizeof(uint64(0)))<<iocSizeShift)
	BRClearDeathNotificationDone = uint32(uintptr(iocRead)<<iocDirShift | uintptr('r')<<iocTypeShift | uintptr(16)<<iocNRShift | uintptr(unsafe.Sizeof(uint64(0)))<<iocSizeShift)
